/**
 * Overwritten fron the base ckan autocomplete module.
 * Extends the base functionality with the placeholder option.
 */
 ...
 *
 */
this.ckan.module('hutemplate-autocomplete', function (jQuery) {
  return {
